...
button1station = Button(Lframe_top, relief="raised", text="1호선", width=27, height=10, command=firststation)
button1station.place(x=0, y=40)

stationback = Button(Lframe_top, relief="raised", text="뒤로 가기", width=20, height=4, command=back_func)
stationback.place_forget()
station1btn1 = Button(Lframe_top, relief="raised", text="노포", width=10, height=2, command=lambda:entrydata(("노포")))
station1btn1.place_forget()
station1btn2 = Button(Lframe_top, relief="raised", text="범어사", width=10, height=2, command=lambda:entrydata(("범어사")))
station1btn2.place_forget()
station1btn3 = Button(Lframe_top, relief="raised", text="남산", width=10, height=2, command=lambda:entrydata(("남산")))
station1btn3.place_forget()
station1btn4 = Button(Lframe_top, relief="raised", text="두실", width=10, height=2, command=lambda:entrydata(("두실")))
station1btn4.place_forget()
station1btn5 = Button(Lframe_top, relief="raised", text="선릉", width=10, height=2, command=lambda:entrydata(("선릉")))
station1btn5.place_forget()
station1btn6 = Button(Lframe_top, relief="raised", text="장전", width=10, height=2, command=lambda:entrydata(("장전")))
station1btn6.place_forget()
station1btn7 = Button(Lframe_top, relief="raised", text="부산대", width=10, height=2, command=lambda:entrydata(("부산대")))
station1btn7.place_forget()
station1btn8 = Button(Lframe_top, relief="raised", text="온천장", width=10, height=2, command=lambda:entrydata(("온천장")))
station1btn8.place_forget()
station1btn9 = Button(Lframe_top, relief="raised", text="명륜", width=10, height=2, command=lambda:entrydata(("명륜")))
station1btn9.place_forget()
station1btn10 = Button(Lframe_top, relief="raised", text="동래", width=10, height=2, command=lambda:entrydata(("동래")))
station1btn10.place_forget()
station1btn11 = Button(Lframe_top, relief="raised", text="교대", width=10, height=2, command=lambda:entrydata(("교대")))
station1btn11.place_forget()
station1btn12 = Button(Lframe_top, relief="raised", text="연산", width=10, height=2, command=lambda:entrydata(("연산")))
station1btn12.place_forget()
station1btn13 = Button(Lframe_top, relief="raised", text="시청", width=10, height=2, command=lambda:entrydata(("시청")))
station1btn13.place_forget()
station1btn14 = Button(Lframe_top, relief="raised", text="양정", width=10, height=2, command=lambda:entrydata(("양정")))
station1btn14.place_forget()
station1btn15 = Button(Lframe_top, relief="raised", text="부전", width=10, height=2, command=lambda:entrydata(("부전")))
station1btn15.place_forget()
station1btn16 = Button(Lframe_top, relief="raised", text="서면", width=10, height=2, command=lambda:entrydata(("서면")))
station1btn16.place_forget()
station1btn17 = Button(Lframe_top, relief="raised", text="범내골", width=10, height=2, command=lambda:entrydata(("범내골")))
station1btn17.place_forget()
station1btn18 = Button(Lframe_top, relief="raised", text="범일", width=10, height=2, command=lambda:entrydata(("범일")))
station1btn18.place_forget()
station1btn19 = Button(Lframe_top, relief="raised", text="좌천(1호선)", width=10, height=2, command=lambda:entrydata(("좌천(1호선)")))
station1btn19.place_forget()
station1btn20 = Button(Lframe_top, relief="raised", text="부산진", width=10, height=2, command=lambda:entrydata(("부산진")))
station1btn20.place_forget()
station1btn21 = Button(Lframe_top, relief="raised", text="초량", width=10, height=2, command=lambda:entrydata(("초량")))
station1btn21.place_forget()
station1btn22 = Button(Lframe_top, relief="raised", text="부산역", width=10, height=2, command=lambda:entrydata(("부산역")))
station1btn22.place_forget()
station1btn23 = Button(Lframe_top, relief="raised", text="중앙", width=10, height=2, command=lambda:entrydata(("중앙")))
station1btn23.place_forget()
station1btn24 = Button(Lframe_top, relief="raised", text="남포", width=10, height=2, command=lambda:entrydata(("남포")))
station1btn24.place_forget()
station1btn25 = Button(Lframe_top, relief="raised", text="자갈치", width=10, height=2, command=lambda:entrydata(("자갈치")))
station1btn25.place_forget()
station1btn26 = Button(Lframe_top, relief="raised", text="토성", width=10, height=2, command=lambda:entrydata(("토성")))
station1btn26.place_forget()
station1btn27 = Button(Lframe_top, relief="raised", text="동대신", width=10, height=2, command=lambda:entrydata(("동대신")))
station1btn27.place_forget()
station1btn28 = Button(Lframe_top, relief="raised", text="서대신", width=10, height=2, command=lambda:entrydata(("서대신")))
station1btn28.place_forget()
station1btn29 = Button(Lframe_top, relief="raised", text="대티", width=10, height=2, command=lambda:entrydata(("대티")))
station1btn29.place_forget()
station1btn30 = Button(Lframe_top, relief="raised", text="과정", width=10, height=2, command=lambda:entrydata(("과정")))
station1btn30.place_forget()
station1btn31 = Button(Lframe_top, relief="raised", text="사하", width=10, height=2, command=lambda:entrydata(("사하")))
station1btn31.place_forget()
station1btn32 = Button(Lframe_top, relief="raised", text="당리", width=10, height=2, command=lambda:entrydata(("당리")))
station1btn32.place_forget()
station1btn33 = Button(Lframe_top, relief="raised", text="하단", width=10, height=2, command=lambda:entrydata(("하단")))
station1btn33.place_forget()
station1btn34 = Button(Lframe_top, relief="raised", text="신평", width=10, height=2, command=lambda:entrydata(("신평")))
station1btn34.place_forget()
station1btn35 = Button(Lframe_top, relief="raised", text="동매", width=10, height=2, command=lambda:entrydata(("동매")))
station1btn35.place_forget()
station1btn36 = Button(Lframe_top, relief="raised", text="장림", width=10, height=2, command=lambda:entrydata(("장림")))
station1btn36.place_forget()
station1btn37 = Button(Lframe_top, relief="raised", text="신장림", width=10, height=2, command=lambda:entrydata(("신장림")))
station1btn37.place_forget()
station1btn38 = Button(Lframe_top, relief="raised", text="낫개", width=10, height=2, command=lambda:entrydata(("낫개")))
station1btn38.place_forget()
station1btn39 = Button(Lframe_top, relief="raised", text="다대포항", width=10, height=2, command=lambda:entrydata(("다대포항")))
station1btn39.place_forget()
station1btn40 = Button(Lframe_top, relief="raised", text="다대포\n해수욕장", width=10, height=2, command=lambda:entrydata(("다대포해수욕장")))
station1btn40.place_forget()

button2station = Button(Lframe_top, relief="raised", text="2호선", width=27, height=10, command=secondstation)
button2station.place(x=0, y=200)

station2btn1 = Button(Lframe_top, relief="raised", text="양산", width=10, height=2, command=lambda:entrydata(("양산")))
station2btn1.place_forget()
station2btn2 = Button(Lframe_top, relief="raised", text="남양산", width=10, height=2, command=lambda:entrydata(("남양산")))
station2btn2.place_forget()
station2btn3 = Button(Lframe_top, relief="raised", text="부산대\n중앙캠퍼스", width=10, height=2, command=lambda:entrydata(("부산대중앙캠퍼스")))
station2btn3.place_forget()
station2btn4 = Button(Lframe_top, relief="raised", text="중산", width=10, height=2, command=lambda:entrydata(("중산")))
station2btn4.place_forget()
station2btn5 = Button(Lframe_top, relief="raised", text="호포", width=10, height=2, command=lambda:entrydata(("호포")))
station2btn5.place_forget()
station2btn6 = Button(Lframe_top, relief="raised", text="금곡", width=10, height=2, command=lambda:entrydata(("금곡")))
station2btn6.place_forget()
station2btn7 = Button(Lframe_top, relief="raised", text="동원", width=10, height=2, command=lambda:entrydata(("동원")))
station2btn7.place_forget()
station2btn8 = Button(Lframe_top, relief="raised", text="율리", width=10, height=2, command=lambda:entrydata(("율리")))
station2btn8.place_forget()
station2btn9 = Button(Lframe_top, relief="raised", text="화명", width=10, height=2, command=lambda:entrydata(("화명")))
station2btn9.place_forget()
station2btn10 = Button(Lframe_top, relief="raised", text="수정", width=10, height=2, command=lambda:entrydata(("수정")))
station2btn10.place_forget()
station2btn11 = Button(Lframe_top, relief="raised", text="덕천", width=10, height=2, command=lambda:entrydata(("덕천")))
station2btn11.place_forget()
station2btn12 = Button(Lframe_top, relief="raised", text="구명", width=10, height=2, command=lambda:entrydata(("구명")))
station2btn12.place_forget()
station2btn13 = Button(Lframe_top, relief="raised", text="구남", width=10, height=2, command=lambda:entrydata(("구남")))
station2btn13.place_forget()
station2btn14 = Button(Lframe_top, relief="raised", text="모라", width=10, height=2, command=lambda:entrydata(("모라")))
station2btn14.place_forget()
station2btn15 = Button(Lframe_top, relief="raised", text="모덕", width=10, height=2, command=lambda:entrydata(("모덕")))
station2btn15.place_forget()
station2btn16 = Button(Lframe_top, relief="raised", text="덕포", width=10, height=2, command=lambda:entrydata(("덕포")))
station2btn16.place_forget()
station2btn17 = Button(Lframe_top, relief="raised", text="사상", width=10, height=2, command=lambda:entrydata(("사상")))
station2btn17.place_forget()
station2btn18 = Button(Lframe_top, relief="raised", text="감전", width=10, height=2, command=lambda:entrydata(("감전")))
station2btn18.place_forget()
station2btn19 = Button(Lframe_top, relief="raised", text="주례", width=10, height=2, command=lambda:entrydata(("주례")))
station2btn19.place_forget()
station2btn20 = Button(Lframe_top, relief="raised", text="냉정", width=10, height=2, command=lambda:entrydata(("냉정")))
station2btn20.place_forget()
station2btn21 = Button(Lframe_top, relief="raised", text="개금", width=10, height=2, command=lambda:entrydata(("개금")))
station2btn21.place_forget()
station2btn22 = Button(Lframe_top, relief="raised", text="동의대", width=10, height=2, command=lambda:entrydata(("동의대")))
station2btn22.place_forget()
station2btn23 = Button(Lframe_top, relief="raised", text="가야", width=10, height=2, command=lambda:entrydata(("가야")))
station2btn23.place_forget()
station2btn24 = Button(Lframe_top, relief="raised", text="부암", width=10, height=2, command=lambda:entrydata(("부암")))
station2btn24.place_forget()
station2btn25 = Button(Lframe_top, relief="raised", text="서면", width=10, height=2, command=lambda:entrydata(("서면")))
station2btn25.place_forget()
station2btn26 = Button(Lframe_top, relief="raised", text="전포", width=10, height=2, command=lambda:entrydata(("전포")))
station2btn26.place_forget()
station2btn27 = Button(Lframe_top, relief="raised", text="국제금융센터\n·부산은행", width=10, height=2, command=lambda:entrydata(("국제금융센터·부산은행")))
station2btn27.place_forget()
station2btn28 = Button(Lframe_top, relief="raised", text="문현", width=10, height=2, command=lambda:entrydata(("문현")))
station2btn28.place_forget()
station2btn29 = Button(Lframe_top, relief="raised", text="지게골", width=10, height=2, command=lambda:entrydata(("지게골")))
station2btn29.place_forget()
station2btn30 = Button(Lframe_top, relief="raised", text="못골", width=10, height=2, command=lambda:entrydata(("못골")))
station2btn30.place_forget()
station2btn31 = Button(Lframe_top, relief="raised", text="대연", width=10, height=2, command=lambda:entrydata(("대연")))
station2btn31.place_forget()
station2btn32 = Button(Lframe_top, relief="raised", text="경성대·부경대", width=10, height=2, command=lambda:entrydata(("경성대·부경대")))
station2btn32.place_forget()
station2btn33 = Button(Lframe_top, relief="raised", text="남천", width=10, height=2, command=lambda:entrydata(("남천")))
station2btn33.place_forget()
station2btn34 = Button(Lframe_top, relief="raised", text="금련산", width=10, height=2, command=lambda:entrydata(("금련산")))
station2btn34.place_forget()
station2btn35 = Button(Lframe_top, relief="raised", text="광안", width=10, height=2, command=lambda:entrydata(("광안")))
station2btn35.place_forget()
station2btn36 = Button(Lframe_top, relief="raised", text="수영", width=10, height=2, command=lambda:entrydata(("수영")))
station2btn36.place_forget()
station2btn37 = Button(Lframe_top, relief="raised", text="민락", width=10, height=2, command=lambda:entrydata(("민락")))
station2btn37.place_forget()
station2btn38 = Button(Lframe_top, relief="raised", text="센텀시티", width=10, height=2, command=lambda:entrydata(("센텀시티")))
station2btn38.place_forget()
station2btn39 = Button(Lframe_top, relief="raised", text="벡스코\n(시립박물관)", width=10, height=2, command=lambda:entrydata(("벡스코(시립박물관)")))
station2btn39.place_forget()
station2btn40 = Button(Lframe_top, relief="raised", text="동백", width=10, height=2, command=lambda:entrydata(("동백")))
station2btn40.place_forget()
station2btn41 = Button(Lframe_top, relief="raised", text="해운대", width=10, height=2, command=lambda:entrydata(("해운대")))
station2btn41.place_forget()
station2btn42 = Button(Lframe_top, relief="raised", text="중동", width=10, height=2, command=lambda:entrydata(("중동")))
station2btn42.place_forget()
station2btn43 = Button(Lframe_top, relief="raised", text="장산", width=10, height=2, command=lambda:entrydata(("장산")))
station2btn43.place_forget()

button3station = Button(Lframe_top, relief="raised", text="3호선", width=27, height=10, command=thirdstation)
button3station.place(x=0, y=360)

station3btn1 = Button(Lframe_top, relief="raised", text="대저", width=10, height=2, command=lambda:entrydata(("대저")))
station3btn1.place_forget()
station3btn2 = Button(Lframe_top, relief="raised", text="체육공원", width=10, height=2, command=lambda:entrydata(("체육공원")))
station3btn2.place_forget()
station3btn3 = Button(Lframe_top, relief="raised", text="강서구청", width=10, height=2, command=lambda:entrydata(("강서구청")))
station3btn3.place_forget()
station3btn4 = Button(Lframe_top, relief="raised", text="구포", width=10, height=2, command=lambda:entrydata(("구포")))
station3btn4.place_forget()
station3btn5 = Button(Lframe_top, relief="raised", text="덕천", width=10, height=2, command=lambda:entrydata(("덕천")))
station3btn5.place_forget()
station3btn6 = Button(Lframe_top, relief="raised", text="숙동", width=10, height=2, command=lambda:entrydata(("숙동")))
station3btn6.place_forget()
station3btn7 = Button(Lframe_top, relief="raised", text="남산정", width=10, height=2, command=lambda:entrydata(("남산정")))
station3btn7.place_forget()
station3btn8 = Button(Lframe_top, relief="raised", text="만덕", width=10, height=2, command=lambda:entrydata(("만덕")))
station3btn8.place_forget()
station3btn9 = Button(Lframe_top, relief="raised", text="미남", width=10, height=2, command=lambda:entrydata(("미남")))
station3btn9.place_forget()
station3btn10 = Button(Lframe_top, relief="raised", text="사직", width=10, height=2, command=lambda:entrydata(("사직")))
station3btn10.place_forget()
station3btn11 = Button(Lframe_top, relief="raised", text="종합운동장", width=10, height=2, command=lambda:entrydata(("종합운동장")))
station3btn11.place_forget()
station3btn12 = Button(Lframe_top, relief="raised", text="거제", width=10, height=2, command=lambda:entrydata(("거제")))
station3btn12.place_forget()
station3btn13 = Button(Lframe_top, relief="raised", text="연산", width=10, height=2, command=lambda:entrydata(("연산")))
station3btn13.place_forget()
station3btn14 = Button(Lframe_top, relief="raised", text="물만골", width=10, height=2, command=lambda:entrydata(("물만골")))
station3btn14.place_forget()
station3btn15 = Button(Lframe_top, relief="raised", text="배산", width=10, height=2, command=lambda:entrydata(("배산")))
station3btn15.place_forget()
station3btn16 = Button(Lframe_top, relief="raised", text="망미", width=10, height=2, command=lambda:entrydata(("망미")))
station3btn16.place_forget()
station3btn17 = Button(Lframe_top, relief="raised", text="수영", width=10, height=2, command=lambda:entrydata(("수영")))
station3btn17.place_forget()

button4station = Button(Lframe_top, relief="raised", text="4호선", width=27, height=10, command=fourstation)
button4station.place(x=200, y=40)

station4btn1 = Button(Lframe_top, relief="raised", text="안평", width=10, height=2, command=lambda:entrydata(("안평")))
station4btn1.place_forget()
station4btn2 = Button(Lframe_top, relief="raised", text="고촌", width=10, height=2, command=lambda:entrydata(("고촌")))
station4btn2.place_forget()
station4btn3 = Button(Lframe_top, relief="raised", text="윗반송", width=10, height=2, command=lambda:entrydata(("윗반송")))
station4btn3.place_forget()
station4btn4 = Button(Lframe_top, relief="raised", text="영산대", width=10, height=2, command=lambda:entrydata(("영산대")))
station4btn4.place_forget()
station4btn5 = Button(Lframe_top, relief="raised", text="석대", width=10, height=2, command=lambda:entrydata(("석대")))
station4btn5.place_forget()
station4btn6 = Button(Lframe_top, relief="raised", text="반여농산물\n시장", width=10, height=2, command=lambda:entrydata(("반여농산물시장")))
station4btn6.place_forget()
station4btn7 = Button(Lframe_top, relief="raised", text="금사", width=10, height=2, command=lambda:entrydata(("금사")))
station4btn7.place_forget()
station4btn8 = Button(Lframe_top, relief="raised", text="서동", width=10, height=2, command=lambda:entrydata(("서동")))
station4btn8.place_forget()
station4btn9 = Button(Lframe_top, relief="raised", text="명장", width=10, height=2, command=lambda:entrydata(("명장")))
station4btn9.place_forget()
station4btn10 = Button(Lframe_top, relief="raised", text="충렬사", width=10, height=2, command=lambda:entrydata(("충렬사")))
station4btn10.place_forget()
station4btn11 = Button(Lframe_top, relief="raised", text="낙민", width=10, height=2, command=lambda:entrydata(("낙민")))
station4btn11.place_forget()
station4btn12 = Button(Lframe_top, relief="raised", text="수안", width=10, height=2, command=lambda:entrydata(("수안")))
station4btn12.place_forget()
station4btn13 = Button(Lframe_top, relief="raised", text="동래", width=10, height=2, command=lambda:entrydata(("동래")))
station4btn13.place_forget()
station4btn14 = Button(Lframe_top, relief="raised", text="미남", width=10, height=2, command=lambda:entrydata(("미남")))
station4btn14.place_forget()

button5station = Button(Lframe_top, relief="raised", text="동해선", width=27, height=10, command=donghaestation)
button5station.place(x=200, y=200)

station5btn1 = Button(Lframe_top, relief="raised", text="태화강", width=10, height=2, command=lambda:entrydata(("태화강")))
station5btn1.place_forget()
station5btn2 = Button(Lframe_top, relief="raised", text="개운포", width=10, height=2, command=lambda:entrydata(("개운포")))
station5btn2.place_forget()
station5btn3 = Button(Lframe_top, relief="raised", text="덕하", width=10, height=2, command=lambda:entrydata(("덕하")))
station5btn3.place_forget()
station5btn4 = Button(Lframe_top, relief="raised", text="망양", width=10, height=2, command=lambda:entrydata(("망양")))
station5btn4.place_forget()
station5btn5 = Button(Lframe_top, relief="raised", text="남창", width=10, height=2, command=lambda:entrydata(("남창")))
station5btn5.place_forget()
station5btn6 = Button(Lframe_top, relief="raised", text="서생", width=10, height=2, command=lambda:entrydata(("서생")))
station5btn6.place_forget()
station5btn7 = Button(Lframe_top, relief="raised", text="월내", width=10, height=2, command=lambda:entrydata(("월내")))
station5btn7.place_forget()
station5btn8 = Button(Lframe_top, relief="raised", text="좌천(동해선)", width=10, height=2, command=lambda:entrydata(("좌천(동해선)")))
station5btn8.place_forget()
station5btn9 = Button(Lframe_top, relief="raised", text="일광", width=10, height=2, command=lambda:entrydata(("일광")))
station5btn9.place_forget()
station5btn10 = Button(Lframe_top, relief="raised", text="기장", width=10, height=2, command=lambda:entrydata(("기장")))
station5btn10.place_forget()
station5btn11 = Button(Lframe_top, relief="raised", text="오시리아", width=10, height=2, command=lambda:entrydata(("오시리아")))
station5btn11.place_forget()
station5btn12 = Button(Lframe_top, relief="raised", text="송정", width=10, height=2, command=lambda:entrydata(("송정")))
station5btn12.place_forget()
station5btn13 = Button(Lframe_top, relief="raised", text="신해운대", width=10, height=2, command=lambda:entrydata(("신해운대")))
station5btn13.place_forget()
station5btn14 = Button(Lframe_top, relief="raised", text="벡스코\n(시립미술관)", width=10, height=2, command=lambda:entrydata(("벡스코(시립미술관)")))
station5btn14.place_forget()
station5btn15 = Button(Lframe_top, relief="raised", text="센텀", width=10, height=2, command=lambda:entrydata(("센텀")))
station5btn15.place_forget()
station5btn16 = Button(Lframe_top, relief="raised", text="재송", width=10, height=2, command=lambda:entrydata(("재송")))
station5btn16.place_forget()
station5btn17 = Button(Lframe_top, relief="raised", text="부산원동", width=10, height=2, command=lambda:entrydata(("부산원동")))
station5btn17.place_forget()
station5btn18 = Button(Lframe_top, relief="raised", text="안락", width=10, height=2, command=lambda:entrydata(("안락")))
station5btn18.place_forget()
station5btn19 = Button(Lframe_top, relief="raised", text="동래(동해선)", width=10, height=2, command=lambda:entrydata(("동래(동해선)")))
station5btn19.place_forget()
station5btn20 = Button(Lframe_top, relief="raised", text="교대", width=10, height=2, command=lambda:entrydata(("교대")))
station5btn20.place_forget()
station5btn21 = Button(Lframe_top, relief="raised", text="거제", width=10, height=2, command=lambda:entrydata(("거제")))
station5btn21.place_forget()
station5btn22 = Button(Lframe_top, relief="raised", text="거제해맞이", width=10, height=2, command=lambda:entrydata(("거제해맞이")))
station5btn22.place_forget()
station5btn23 = Button(Lframe_top, relief="raised", text="부전", width=10, height=2, command=lambda:entrydata(("부전")))
station5btn23.place_forget()

button6station = Button(Lframe_top, relief="raised", text="부산김해선", width=27, height=10, command=kimhaestation)
button6station.place(x=200, y=360)

station6btn1 = Button(Lframe_top, relief="raised", text="가야대", width=10, heigh=2, command=lambda:entrydata(("가야대")))
station6btn1.place_forget()
station6btn2 = Button(Lframe_top, relief="raised", text="장신대", width=10, heigh=2, command=lambda:entrydata(("장신대")))
station6btn2.place_forget()
station6btn3 = Button(Lframe_top, relief="raised", text="연지공원", width=10, heigh=2, command=lambda:entrydata(("연지공원")))
station6btn3.place_forget()
station6btn4 = Button(Lframe_top, relief="raised", text="박물관", width=10, heigh=2, command=lambda:entrydata(("박물관")))
station6btn4.place_forget()
station6btn5 = Button(Lframe_top, relief="raised", text="수로왕릉", width=10, heigh=2, command=lambda:entrydata(("수로왕릉")))
station6btn5.place_forget()
station6btn6 = Button(Lframe_top, relief="raised", text="봉황", width=10, heigh=2, command=lambda:entrydata(("봉황")))
station6btn6.place_forget()
station6btn7 = Button(Lframe_top, relief="raised", text="부원", width=10, heigh=2, command=lambda:entrydata(("부원")))
station6btn7.place_forget()
station6btn8 = Button(Lframe_top, relief="raised", text="김해시청", width=10, heigh=2, command=lambda:entrydata(("김해시청")))
station6btn8.place_forget()
station6btn9 = Button(Lframe_top, relief="raised", text="인제대", width=10, heigh=2, command=lambda:entrydata(("인제대")))
station6btn9.place_forget()
station6btn10 = Button(Lframe_top, relief="raised", text="김해대학", width=10, heigh=2, command=lambda:entrydata(("김해대학")))
station6btn10.place_forget()
station6btn11 = Button(Lframe_top, relief="raised", text="지내", width=10, heigh=2, command=lambda:entrydata(("지내")))
station6btn11.place_forget()
station6btn12 = Button(Lframe_top, relief="raised", text="불암", width=10, heigh=2, command=lambda:entrydata(("불암")))
station6btn12.place_forget()
station6btn13 = Button(Lframe_top, relief="raised", text="대사", width=10, heigh=2, command=lambda:entrydata(("대사")))
station6btn13.place_forget()
station6btn14 = Button(Lframe_top, relief="raised", text="평강", width=10, heigh=2, command=lambda:entrydata(("평강")))
station6btn14.place_forget()
station6btn15 = Button(Lframe_top, relief="raised", text="대저", width=10, heigh=2, command=lambda:entrydata(("대저")))
station6btn15.place_forget()
station6btn16 = Button(Lframe_top, relief="raised", text="등구", width=10, heigh=2, command=lambda:entrydata(("등구")))
station6btn16.place_forget()
station6btn17 = Button(Lframe_top, relief="raised", text="덕두", width=10, heigh=2, command=lambda:entrydata(("덕두")))
station6btn17.place_forget()
station6btn18 = Button(Lframe_top, relief="raised", text="공항", width=10, heigh=2, command=lambda:entrydata(("공항")))
station6btn18.place_forget()
station6btn19 = Button(Lframe_top, relief="raised", text="서부산\n유통지구", width=10, heigh=2, command=lambda:entrydata(("서부산유통지구")))
station6btn19.place_forget()
station6btn20 = Button(Lframe_top, relief="raised", text="괘법\n르네시떼", width=10, heigh=2, command=lambda:entrydata(("괘법르네시떼")))
station6btn20.place_forget()
station6btn21 = Button(Lframe_top, relief="raised", text="사상", width=10, heigh=2, command=lambda:entrydata(("사상")))
station6btn21.place_forget()
...
destination_entry.bind("<Return>")

timelabel = Label(Lframe_top, text="현재시각 : ", font=("Arial", 15), bg="lightgray")
timelabel.place(x=55, y=5)

searchbutton = Button(Lframe_bottom, text="검색", font=("Arial", 15), background="cyan", command=lambda: (result()))
